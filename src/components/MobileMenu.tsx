  ...
  return (
    ...
    >
      <div className='flex flex-col h-full w-full'>
        ...
        <nav className='flex-1 flex items-center justify-center' role="navigation" aria-label="Mobile navigation">
        ...
        <div className='flex justify-center py-8 gap-5' role="list" aria-label="Social links" data-testid="social-links">
          <a
